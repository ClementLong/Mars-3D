      ...
      <div class="result__graph">
        ...
        <div class="result__graphZone">
          <div id="martien" class="category">
            <div data-value="<?php echo '12'; ?>%" style="height: calc(<?php echo '12'; ?>* 10px);" class="category__value"></div>
            <div class="category__name">Martien</div>
          </div>
          <div id="pionner" class="category">
            <div data-value="<?php echo '20'; ?>%" style="height: calc(<?php echo '20'; ?>* 10px);" class="category__value"></div>
            <div class="category__name">Pionnier</div>
          </div>
          <div id="aventurier" class="category">
            <div data-value="<?php echo '25'; ?>%" style="height: calc(<?php echo '25'; ?>* 10px);" class="category__value"></div>
            <div class="category__name">Aventurier</div>
          </div>
          <div id="touriste" class="category">
            <div data-value="<?php echo '30'; ?>%" style="height: calc(<?php echo '30'; ?> * 10px);" class="category__value"></div>
            <div class="category__name">Touriste</div>
          </div>
          <div id="terrien" class="category">
            <div data-value="<?php echo '8'; ?>%" style="height: calc(<?php echo '8'; ?> * 10px);" class="category__value"></div>
